...
class Controller extends BaseController
{
    ...
    {        
        ...
        $funcionario = DB::connection('mamore')->table('people as p')
            ...
            ->select('p.id as id_funcionario', 'p.ci as N_Carnet', 'c.cargo_id', 'c.job_id', 'j.name as cargo', DB::raw("CONCAT(p.first_name, ' ', p.last_name) as nombre"), 'c.direccion_administrativa_id as id_direccion', 'd.nombre as direccion', 'c.unidad_administrativa_id as id_unidad', 'u.nombre as unidad')
            ->first();
