                ...
                <div class="panel panel-bordered">
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-8" style="padding: 0px">
                            <h1 class="page-title">
                                <i class="voyager-calendar"></i> Reporte Notas Recibidas
                            </h1>
                        </div>
                        <div class="col-md-4" style="margin-top: 30px">
                            <form name="form_search" id="form-search" action="{{ route('print.report.bandeja') }}" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <select name="people" class="form-control select2" required>
