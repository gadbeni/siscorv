                                ...
                                <div class="form-group">
                                    ...
                                    <select name="person_id" class="form-control select2" required>
                                        ...
                                        @foreach($people as $person)
                                            <option value="{{ $person->id }}">{{ $person->ci }} - {{ $person->first_name }} {{ $person->paternal_surname }} {{ $person->maternal_surname }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center" style="text-transform: uppercase">
                            ...
                            <br>
                            <p><b>¿Dar de Baja este registro?</b></p>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn btn-warning btn-sm">Confirmar Baja</button>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center" style="text-transform: uppercase">
                            ...
                            <br>
                            <p><b>¿Desea eliminar este registro?</b></p>
                        </div>
                    </div>
